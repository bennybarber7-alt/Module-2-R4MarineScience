...
## Introduction
 In this workshop, I focused on tidying and reshaping data, separating and combining variables, cleaning strings and dates, joining different data frames and handling missing values. These skills helped me better understand how messy datasets can be organised into a format that is easier to analyse.
