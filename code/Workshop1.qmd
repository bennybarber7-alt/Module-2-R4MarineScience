---
title: "Module 2 - R in marine science Workshop 1"
author: "Ben Barbe"
date: "`r format(Sys.time(), '%d %B, %Y')`"
format: html
---

# MB5370: Techniques in Marine Science 1: R in Marine Science Workshop 1

# Introduction: Data Wrangling and Visualisation

This workshop built on my basic R skills by applying them to the Palmer Penguins dataset. I practised cleaning, summarising and plotting ecological data while learning how to manage missing values and check that the results made biological sense.
...
```
Observe your console feedback. The tibble structure tells its dimensions and highlights variable configurations right below the column headers. This constant visual validation is your primary defense against typing errors.
...
```
the summary() function provides a quick overview of the dataset, including the minimum, maximum, mean, and quartiles for numerical variables, as well as counts for categorical variables. Values that come back NA indicate missing data, which is common in ecological datasets.
...
ggsave("../Outputs/figures/SE_mass_compare_plot.png", 
       ...
       units = "mm", dpi = 300)
#Saving the plot as a high-resolution PNG file in the Outputs/figures directory with specified dimensions and resolution.

```


# Workshop Reflection
This workshop allowed me to deepen my understanding of R for ecological data analysis. I learned how to effectively clean and manipulate datasets, handle missing values, and create informative visualizations that convey both the central tendencies and variability of the data. The exercise of comparing standard deviation and standard error in the context of penguin body mass provided valuable insights into how different statistical measures can influence our interpretation of biological data. Overall, this workshop has enhanced my ability to analyze and present ecological data in a meaningful way.
