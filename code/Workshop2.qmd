---
title: "Module 2 - R in marine science Workshop 2"
author: "Ben Barber"
date: "2026-06-03"
format:   
  html:
...
# MB5370: Techniques in Marine Science 1: R in Marine Science Workshop 2

## Introduction: Advanced Data Wrangling and Tidy Data

This workshop improved my confidence in cleaning and reorganising complex datasets in R. I learned that tidy data, consistent formatting and careful handling of missing values are essential for combining datasets correctly and producing reliable results.
...
this workshop showed me how to clean and reorganise complex datasets in R. I learned that tidy data, consistent formatting and careful handling of missing values are essential for combining datasets correctly and producing reliable results. I also learned how to use pivot_longer() and pivot_wider() to reshape data, as well as how to use separate() and unite() to split and combine columns. Finally, I learned how to use stringr and lubridate to standardize text and parse dates, respectively. Overall, this workshop improved my confidence in cleaning and reorganising complex datasets in R.